...
const Sidebar = () => {
  ...
  return (
    <Card className='card h-screen flex flex-col justify-between py-5'>
      ...
      <div className='space-y-9 space-x-5 '>
        {navigationMenu.map((item)=>(
          ...
          <div>
            <Divider/>
            <div className='pl-5 items-center justify-between pt-5'>
              <div className='flex items-center space-x-3'>
                <Avatar src="https://cdn.pixabay.com/photo/2017/03/21/02/00/user-2160923_1280.png"/>
                <div>
